...
class ThemeProvider with ChangeNotifier {
  int light = 1;
  int dark = 4;
  ThemeMode selectedThemeMode = appThemes[2].mode;

  setSelectedThemeMode(ThemeMode themeMode) {
    selectedThemeMode = themeMode;
    if (selectedThemeMode == ThemeMode.dark ||
        selectedThemeMode == ThemeMode.system) {
      selectedPrimaryColor = AppColors.primaryColors[dark];
    } else {
      selectedPrimaryColor = AppColors.primaryColors[light];
    }
    notifyListeners();
  }

  Color selectedPrimaryColor = AppColors.primaryColors[4];
